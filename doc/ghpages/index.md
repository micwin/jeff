...
- `jeff room` coordinates file-backed specialist rooms and routes prefixed turns through configured `codex-ctl` experts.
...
- [Download Jeff v0.3.32](https://github.com/micwin/jeff/releases/tag/v0.3.32)
- [Release notes]({{ "/releases/v0.3.32.html" | relative_url }})
<!-- latest-release:end -->
